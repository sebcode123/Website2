...
const serviceCards = [
  { title: "Exterior Detail", desc: "Deep clean, decontaminate, and protect your exterior to a showroom shine." },
  { title: "Interior Detail", desc: "Thorough interior cleaning for a fresh, comfortable driving experience." },
  { title: "Full Detail Package", desc: "The ultimate complete clean for interior, exterior, and everything in between." },
  { title: "Ceramic Coating", desc: "Long-lasting paint protection that adds gloss, depth, and water resistance." },
  { title: "Wax Application", desc: "Premium wax finish that enhances shine and adds a protective layer." },
  { title: "Paint Correction", desc: "Removes swirl marks, light scratches, and restores deep paint gloss." },
  { title: "Clay Bar Treatment", desc: "Removes embedded contaminants for a smooth, clean paint surface." },
];
...
export default function App() {
  ...
  const toggleAddOn = (item) => {
    setSelectedAddOns((current) =>
      current.find((x) => x.name === item.name)
  ...
  return (
    <div className="bg-black text-white">
      ...
      <section className="px-6 py-24">
        <h2 className="mb-14 text-center text-5xl font-black">Our Services</h2>
      ...
      <section className="bg-neutral-100 px-6 py-24 text-black">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-14 text-center text-5xl font-black">Booking System</h2>

          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              <h3 className="mb-5 text-2xl font-black">Choose Vehicle</h3>
              ...
              <h3 className="mb-5 mt-12 text-2xl font-black">Choose Service</h3>
              ...
              <h3 className="mb-5 mt-12 text-2xl font-black">Add Ons</h3>
              ...
              <div className="grid gap-4">
                {addOns.map((item) => (
                  <button
                    ...
                    className={`flex items-center justify-between rounded-3xl border p-6 transition ${
                      selectedAddOns.find((x) => x.name === item.name)
              ...
              <h3 className="mb-5 mt-12 text-2xl font-black">Choose Date & Time</h3>
            ...
            <div className="rounded-[2rem] bg-black p-10 text-white shadow-2xl">
              ...
              <h3 className="text-4xl font-black">Booking Summary</h3>
              ...
              <p className="mt-4 text-center text-sm text-neutral-500">
                Date, name, phone, and email are required before booking.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-7xl">
          <h2 className="mb-6 text-center text-5xl font-black">Portfolio</h2>
